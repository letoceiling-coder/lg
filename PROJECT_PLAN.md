...
- [x] Ссылка на ЖК
- [ ] Кнопки: заявка, избранное, презентация *(LeadForm с `listingId`/`blockId` → БД; сердечко — UI)*
...
- [ ] Таблица параметров в строках *(как в ТЗ — пока только карточки)*
- [ ] Удаление / добавление в избранное *(удаление из сравнения есть; связка с избранным — нет)*
...
| Сравнение ЖК | **Карточки из API** по slug; добавление с карточки каталога; не полная таблица параметров |
