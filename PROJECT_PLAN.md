...
| Область | Статус |
|--------|--------|
| Auth: Telegram Login, телефон в login/register | Частично: в настройках заведён `telegram_login_bot_username` для будущего виджета; верификация на бэке — не готово |
